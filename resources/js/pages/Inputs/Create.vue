...
const form = ref({
    filaments: '',
    energy: '',
    dt_buy: new Date().toISOString().split('T')[0],
    cost_buy: '',
    purge: '0',
});
    ...
    <div class="space-y-6 p-4 md:p-6">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-muted-foreground">Register a new filament or material input</p>
            </div>
        </div>
        ...
        <form @submit.prevent="submit">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Fill in the material/resource information</CardDescription>
                </CardHeader>
                <CardContent class="space-y-6">
                    <div class="space-y-2">
                        ...
                        <Input
                            ...
                            placeholder="e.g., PLA 1.75mm, ABS 1.75mm"
                            :class="{ 'border-destructive': errors.filaments }"
                        />
                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        ...
                        <div class="space-y-2">
                            ...
                            <Input id="cost_buy" type="number" step="0.01" min="0" v-model="form.cost_buy" placeholder="0.00" :class="{ 'border-destructive': errors.cost_buy }" />
                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        <div class="space-y-2">
                            ...
                            <Input id="energy" type="number" step="0.01" min="0" v-model="form.energy" placeholder="0.00" :class="{ 'border-destructive': errors.energy }" />
                            <span v-if="errors.energy" class="text-sm text-destructive">{{ errors.energy }}</span>
                        </div>
                        <div class="space-y-2">
                            <Label for="purge">Purge (grams)</Label>
                            <Input id="purge" type="number" step="0.1" min="0" v-model="form.purge" placeholder="0" :class="{ 'border-destructive': errors.purge }" />
