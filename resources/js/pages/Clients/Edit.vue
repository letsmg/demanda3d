...
<template>
    ...
    <div class="space-y-6 p-4 md:p-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold tracking-tight md:text-3xl">Editar Cliente</h1>
        ...
        <form @submit.prevent="submit">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Edite os dados do cliente abaixo</CardDescription>
                </CardHeader>
                <CardContent class="space-y-6">
                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        <div class="space-y-2">
                            ...
                            <Input id="name" v-model="form.name" placeholder="Nome do cliente" :class="{ 'border-destructive': form.errors.name }" />
                            <span v-if="form.errors.name" class="text-sm text-destructive">{{ form.errors.name }}</span>
                        </div>
                        <div class="space-y-2">
                            <Label for="doc">CPF / CNPJ *</Label>
                            <Input id="doc" v-model="form.doc" placeholder="00.000.000/0000-00" :class="{ 'border-destructive': form.errors.doc }" />
                    ...
                    <div class="grid gap-4 sm:grid-cols-3">
                        <div class="space-y-2 sm:col-span-2">
                            ...
                            <Input id="address" v-model="form.address" placeholder="Rua, Avenida..." :class="{ 'border-destructive': form.errors.address }" />
                            <span v-if="form.errors.address" class="text-sm text-destructive">{{ form.errors.address }}</span>
                        </div>
                        <div class="space-y-2">
                            <Label for="number">Número *</Label>
                            <Input id="number" v-model="form.number" placeholder="123" :class="{ 'border-destructive': form.errors.number }" />
                    ...
                    <div class="grid gap-4 sm:grid-cols-3">
                        <div class="space-y-2">
                            ...
                            <Input id="city" v-model="form.city" placeholder="São Paulo" :class="{ 'border-destructive': form.errors.city }" />
                            <span v-if="form.errors.city" class="text-sm text-destructive">{{ form.errors.city }}</span>
                        </div>
                        <div class="space-y-2">
                            <Label for="state">UF *</Label>
                            <Input id="state" v-model="form.state" placeholder="SP" maxlength="2" :class="{ 'border-destructive': form.errors.state }" />
                            <span v-if="form.errors.state" class="text-sm text-destructive">{{ form.errors.state }}</span>
                        </div>
                        <div class="space-y-2">
                            <Label for="zipcode">CEP *</Label>
                            <Input id="zipcode" v-model="form.zipcode" placeholder="00000-000" :class="{ 'border-destructive': form.errors.zipcode }" />
                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        <div class="space-y-2">
                            ...
                            <Input id="phone1" v-model="form.phone1" placeholder="(11) 99999-0000" :class="{ 'border-destructive': form.errors.phone1 }" />
                            <span v-if="form.errors.phone1" class="text-sm text-destructive">{{ form.errors.phone1 }}</span>
                        </div>
                        <div class="space-y-2">
                            <Label for="phone2">Telefone 2</Label>
                            <Input id="phone2" v-model="form.phone2" placeholder="(11) 3333-0000" />
                        </div>
                    </div>
                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        <div class="space-y-2">
                            ...
                            <Input id="contact1" v-model="form.contact1" placeholder="Nome do contato principal" />
                        </div>
                        <div class="space-y-2">
                            <Label for="contact2">Contato 2</Label>
                            <Input id="contact2" v-model="form.contact2" placeholder="Nome do contato secundário" />
                        </div>
                    </div>
                </CardContent>
            </Card>
