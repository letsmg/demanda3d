        ...
        <Card class="border-amber-500 bg-amber-50/80 shadow-sm">
            <CardHeader class="pb-2 text-center">
                <CardTitle class="text-xl text-amber-900"
                    >Entrar como Vendedor</CardTitle
                >
                <CardDescription class="text-amber-600"
                    >Digite seu email e senha abaixo para
                    entrar</CardDescription
                >
            </CardHeader>
            <CardContent class="space-y-6">
                <div
                    class="rounded-lg border border-dashed border-amber-900/50 bg-amber-100/50 p-3"
                >
                    <p
                    ...
                    <div class="grid gap-4">
                        <div class="grid gap-2">
                            ...
                            <Input
                                ...
                                autofocus
                                :tabindex="1"
                                class="placeholder:text-amber-910 border-amber-900 bg-white text-amber-900 focus:border-amber-500 focus:ring-amber-500"
                    ...
                    <div class="space-y-1 text-center text-xs text-amber-600">
                        ...
                        <div>
                            <Link
                                :href="'/login_carrier'"
                                class="font-medium text-amber-700 hover:text-amber-900"
                                >Acesse como Transportadora</Link
                            >
                        </div>
                    </div>
                </form>
