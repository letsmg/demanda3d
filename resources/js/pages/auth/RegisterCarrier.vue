            ...
            <CardContent>
                ...
                <form @submit.prevent="submit" class="mt-3 flex flex-col gap-6">
                    <div class="grid gap-4">
                        ...
                        <p class="text-xs text-amber-600">Após o cadastro, você será direcionado para completar os dados da sua transportadora.</p>
                        ...
                        <div class="flex gap-2">
                            <Button type="submit" class="flex-1 bg-amber-500 font-semibold text-amber-950 hover:bg-amber-910" :tabindex="5" :disabled="form.processing">
                                <Spinner v-if="form.processing" /> Criar Conta de Transportadora
                            </Button>
                            <Button type="button" variant="outline" class="border-amber-900 text-amber-700 hover:bg-amber-50" :tabindex="6" @click="form.reset()">
                                Limpar
                            </Button>
                        </div>
                    </div>
