        ...
        <Card>
            <CardContent class="pt-4">
                ...
                <table v-else class="w-full text-sm">
                    ...
                    <tbody>
                        <tr
                            v-for="a in agreements.data"
                            :key="a.id"
                            class="border-b"
                        >
                            <td class="py-2">
                                {{ a.tenant?.fantasy_name ?? '—' }}
                            </td>
                            <td>
                                <span
                            ...
                            <td class="space-x-2 text-right">
                                <Link
                                    v-if="a.status === 'pending_carrier'"
                                    :href="`/carrier/agreements/${a.id}/accept`"
                                    method="post"
                                    as="button"
                                ...
                                <Link
                                    v-if="a.status === 'pending_carrier'"
                                    :href="`/carrier/agreements/${a.id}/reject`"
                                    method="post"
                                    as="button"
