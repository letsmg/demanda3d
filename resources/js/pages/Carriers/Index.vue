        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-muted-foreground">
                    Gerencie suas transportadoras de frete
                </p>
            </div>
            <Button as-child
                ><Link href="/carriers/create"
                    ><Plus class="mr-2 h-4 w-4" />Nova Transportadora</Link
                ></Button
            >
        </div>
        <Card>
            <CardHeader>
                ...
                <CardDescription
                    >{{ carriers.data?.length || 0 }} transportadoras
                    cadastradas</CardDescription
                >
            </CardHeader>
            <CardContent>
