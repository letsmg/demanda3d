...
<template>
    ...
    <div class="space-y-6 p-4 md:p-6">
        ...
        <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="text-2xl font-bold tracking-tight md:text-3xl">Painel</h1>
        ...
        <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <Card class="transition-all hover:shadow-md">
                ...
                <CardContent>
                    ...
                    <p class="text-xs text-muted-foreground">
                        <Link :href="clientsIndex()" class="text-primary hover:underline">Ver todos os clientes</Link>
                    </p>
                </CardContent>
            </Card>
            ...
            <Card class="transition-all hover:shadow-md">
                ...
                <CardContent>
                    ...
                    <p class="text-xs text-muted-foreground">
                        <Link :href="ordersIndex()" class="text-primary hover:underline">Ver todos os pedidos</Link>
                    </p>
                </CardContent>
            </Card>
            ...
            <Card class="transition-all hover:shadow-md">
                <CardHeader class="flex flex-row items-center justify-between pb-2">
                    <CardTitle class="text-sm font-medium">Receita Mensal</CardTitle>
                ...
                <CardContent>
                    ...
                    <p class="text-xs text-muted-foreground">
                        <span>{{ stats.monthly_orders_count }} pedidos este mês</span>
                    </p>
                </CardContent>
            </Card>
            ...
            <Card class="transition-all hover:shadow-md">
                <CardHeader class="flex flex-row items-center justify-between pb-2">
                    <CardTitle class="text-sm font-medium">Entregas Pendentes</CardTitle>
                ...
                <CardContent>
                    ...
                    <p class="text-xs text-muted-foreground">
                        <span class="text-amber-600 dark:text-amber-400">Aguardando entrega</span>
                    </p>
                </CardContent>
            </Card>
        </div>
        ...
        <div class="grid gap-4 md:grid-cols-2">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Últimos materiais cadastrados</CardDescription>
                </CardHeader>
                <CardContent>
                    ...
                    <div class="mt-3 text-center">
                        <Link :href="inputsIndex()" class="text-xs text-primary hover:underline">
                        ...
                        <table class="w-full">
                            <thead>
                                <tr class="border-b text-left text-sm font-medium text-muted-foreground">
                                    ...
                                    <th class="pb-3 pr-4">Data do Pedido</th>
                                    <th class="pb-3 pr-4">Data de Entrega</th>
                            ...
                            <tbody>
                                ...
                                >
                                    <td class="py-3 pr-4 text-sm font-medium">
                                        <Link
                                            :href="ordersEdit({ order: order.id })"
                                    ...
                                    <td class="py-3 text-right">
                                        ...
                                        >
                                            {{ new Date(order.delivery_date) > new Date() ? 'Pendente' : 'Entregue' }}
                                        </Badge>
                                    </td>
                                </tr>
                            </tbody>
                    ...
                    <div class="space-y-3 md:hidden">
                        ...
                        >
                            <div class="mb-2 flex items-center justify-between">
                                <span class="font-medium">{{ order.client?.name || `Cliente #${order.client_id}` }}</span>
                                <Badge
                                    :variant="new Date(order.delivery_date) > new Date() ? 'secondary' : 'default'"
                                >
                                    {{ new Date(order.delivery_date) > new Date() ? 'Pendente' : 'Entregue' }}
