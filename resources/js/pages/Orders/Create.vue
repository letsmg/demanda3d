...
<template>
    ...
    <div class="space-y-6 p-4 md:p-6">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold tracking-tight md:text-3xl">Criar Pedido</h1>
                <p class="text-sm text-muted-foreground">Registrar um novo pedido de impressão 3D</p>
            </div>
        </div>
        ...
        <form @submit.prevent="submit">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Preencha os dados do pedido abaixo</CardDescription>
                </CardHeader>
            ...
            <div class="mt-6 flex items-center justify-end gap-3">
                ...
                <Button type="submit" :disabled="form.processing">
                    <Save class="mr-2 h-4 w-4" /> {{ form.processing ? 'Salvando...' : 'Salvar Pedido' }}
                </Button>
            </div>
        </form>
    </div>
