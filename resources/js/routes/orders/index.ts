...
/**
* @see \App\Http\Controllers\Inertia\OrderController::create
* @see app/Http/Controllers/Inertia/OrderController.php:31
* @route '/orders/create'
*/
...
/**
* @see \App\Http\Controllers\Inertia\OrderController::store
* @see app/Http/Controllers/Inertia/OrderController.php:40
* @route '/orders'
*/
...
/**
* @see \App\Http\Controllers\Inertia\OrderController::edit
* @see app/Http/Controllers/Inertia/OrderController.php:48
...
/**
* @see \App\Http\Controllers\Inertia\OrderController::update
* @see app/Http/Controllers/Inertia/OrderController.php:59
* @route '/orders/{order}'
*/
...
/**
* @see \App\Http\Controllers\Inertia\OrderController::destroy
* @see app/Http/Controllers/Inertia/OrderController.php:67
* @route '/orders/{order}'
*/
