...
/**
* @see \App\Http\Controllers\Inertia\ClientController::create
* @see app/Http/Controllers/Inertia/ClientController.php:29
...
/**
* @see \App\Http\Controllers\Inertia\ClientController::store
* @see app/Http/Controllers/Inertia/ClientController.php:34
* @route '/clients'
*/
...
/**
* @see \App\Http\Controllers\Inertia\ClientController::edit
* @see app/Http/Controllers/Inertia/ClientController.php:42
...
/**
* @see \App\Http\Controllers\Inertia\ClientController::update
* @see app/Http/Controllers/Inertia/ClientController.php:49
...
/**
* @see \App\Http\Controllers\Inertia\ClientController::destroy
* @see app/Http/Controllers/Inertia/ClientController.php:57
* @route '/clients/{client}'
*/
