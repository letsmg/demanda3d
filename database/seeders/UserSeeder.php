...
class UserSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // ── Admin ───────────────────────────────────────────
        $this->upsertUser('Admin', 'Master', 'Admin Master', 'admin@teste.com', UserAccessLevel::ADMIN);
        $this->upsertUser('Admin', 'Suporte', 'Admin Suporte', 'admin2@teste.com', UserAccessLevel::ADMIN_2);
        ...
        for ($i = 1; $i <= 5; $i++) {
            ...
            $this->upsertTenant($user1, $tenantCompany);
    ...
    private function upsertUser(string $firstName, string $lastName, string $displayName, string $email, UserAccessLevel $level): \App\Models\User
    {
    ...
    private function upsertTenant(\App\Models\User $user, string $companyName): Tenant
    {
